...
const FloatingCheckoutButton = () => {
    ...
    // - Currently on cart, checkout, menu, edit-profile, or profile pages
    const currentRoute = segments.join('/')
    if (totalItems === 0 || !hasVisitedCheckout || currentRoute.includes('cart') || currentRoute.includes('checkout') || currentRoute.includes('menu') || currentRoute.includes('edit-profile') || currentRoute.includes('profile')) return null
